document.addEventListener('DOMContentLoaded', () => {
    ...
    function fetchWeatherData(place) {
        const url = `https://api.weatherapi.com/v1/current.json?key=47acff46987540ea933174127241605&q=${place}&aqi=no`;
    ...
    function changeBackgroundImage(location) {
        const imageUrl = `https://source.unsplash.com/random/?${location}`;
